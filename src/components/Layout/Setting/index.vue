    ...
    <div class="drawer-con">
      ...
      <div class="theme-wrap">
        ...
        >
          ...
          <p class="name">{{ index === 0 ? '浅色' : (index === 1 ? '深色' : '系统')}}</p>
          <div class="active" v-show="item.theme === systemThemeMode"></div>
        </div>
      </div>

      <p class="title" style="margin-top: 30px">菜单风格</p>
      ...
      <div v-if="width > 1000">
        <!-- 菜单布局 -->
        <p class="title" style="margin-top: 10px">菜单布局</p>
        <div class="menu-type">
      ...
      <p class="title" style="margin-top: 50px">基础配置</p>
      <div class="basic-box">
